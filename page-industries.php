...
<html class="js cssanimations js_active  vc_desktop  vc_transform  vc_transform " lang="en-US">
  ...
  <head>
    <meta charset="UTF-8">
    <title>Industries – Interactive Group</title>
    ...
    <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="https://ae.interactivegrp.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fae.interactivegrp.com%2Findustries%2F">
    <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="https://ae.interactivegrp.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fae.interactivegrp.com%2Findustries%2F&amp;format=xml">
    ...
    <link rel="alternate" title="JSON" type="application/json" href="https://ae.interactivegrp.com/wp-json/wp/v2/pages/295">
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://ae.interactivegrp.com/xmlrpc.php?rsd">
    <meta name="generator" content="WordPress 7.0">
    <link rel="canonical" href="https://ae.interactivegrp.com/industries/">
    <link rel="shortlink" href="https://ae.interactivegrp.com/?p=295">
    ...
    <style type="text/css" data-type="vc_shortcodes-custom-css">
      .vc_custom_1605094750210 {
        background: #ffffff url(https://ae.interactivegrp.com/wp-content/uploads/2020/02/Group-253.jpg?id=298) !important;
  ...
  <body id="grve-body" class="wp-singular page-template-default page page-id-295 wp-theme-movedo wp-child-theme-movedo-child grve-vce-ver-3.2.2 grve-body grve-stretched wpb-js-composer js-comp-ver-7.9 vc_responsive" cz-shortcut-listen="true">
    <!-- Theme Wrapper -->
    <div id="grve-theme-wrapper" class="" data-mask-layer="2">
      <div id="grve-theme-content">
        ...
        <header id="grve-header" class="grve-fullwidth" data-sticky="none" data-sticky-height="60" data-devices-sticky="no" data-devices-sticky-height="60">
          ...
          <span class="cursor">
            <span class="cursor-move-inner" style="transform: translate3d(260.028px, 240.077px, 0px);">
              <span class="cursor-inner"></span>
            </span>
            <span class="cursor-move-outer" style="transform: translate3d(260.091px, 240.23px, 0px);">
            ...
            <div id="grve-main-content">
              <div class="grve-main-content-wrapper clearfix">
                ...
                <div id="page-295" class="post-295 page type-page status-publish hentry">
                    ...
                    <div class="grve-container">
                      <div class="grve-row grve-bookmark grve-columns-gap-45">
                        <div class="grve-column wpb_column grve-column-1 home-banner-left grve-middle">
                          <div class="grve-column-wrapper" style="height: 590px;">
                            <div class="grve-row-inner grve-bookmark vc_custom_1605094750210 intgrpslliderev">
                              <div class="grve-column-inner wpb_column grve-column-2-3 page-bg-heading">
                                <div class="grve-column-wrapper-inner">
                                  ...
                                  <p style="color: #ffffff;text-align: left" class="vc_custom_heading vc_do_custom_heading pd-right">New age communications technology has given birth to new challenges and exciting opportunities for people across the globe. It has revolutionized the way we approach and solve issues of human condition. Maneuvering the potential of information and communications technology (ICT) in the region, Interactive Group together with its alliance partners is working towards enhancing ICT market’s readiness and enabling access to all members of society and businesses.</p>
                                  <div class="grve-empty-space" style="height: 190px;"></div>
                                  <div class="grve-element grve-align-left">
                                    <a href="#about-section1" class="grve-btn grve-btn-medium grve-square grve-bg-white grve-bg-hover-primary-1 page-scroll-btn">
                                      <span>
                                        <i class="vc-oi vc-oi-down"></i>Scroll Down </span>
                                    </a>
                                  </div>
                                </div>
                              </div>
                  ...
                  <div class="grve-section grve-row-section grve-fullwidth-background grve-padding-top-4x grve-padding-bottom-3x grve-bg-none grve-custom-height grve-middle-content grve-show-custom-height" id="about-section1" data-tablet-landscape-equal-columns="false" data-tablet-portrait-equal-columns="false" data-mobile-equal-columns="false">
                    <div class="grve-container">
                          ...
                          <div class="grve-column-wrapper" style="height: 414px;">
                            <div class="grve-element grve-image grve-animated-item grve-duration-normal grve-fade-in-left bluebgbox_lt grve-align-center grve-animated" style="" data-delay="200">
                              <div class="grve-image-wrapper">
                                <img fetchpriority="high" decoding="async" width="722" height="532" src="https://ae.interactivegrp.com/wp-content/uploads/2020/02/Artboard-23@2x-100.jpg" class="attachment-full size-full" alt="" srcset="https://ae.interactivegrp.com/wp-content/uploads/2020/02/Artboard-23@2x-100.jpg 722w, https://ae.interactivegrp.com/wp-content/uploads/2020/02/Artboard-23@2x-100-300x221.jpg 300w, https://ae.interactivegrp.com/wp-content/uploads/2020/02/Artboard-23@2x-100-600x442.jpg 600w" sizes="(max-width: 722px) 100vw, 722px" style="opacity: 1;">
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="grve-column-wrapper" style="height: 414px;">
                            ...
                            <div class="grve-element grve-box-icon grve-small grve-side-icon grve-align-left lh_52 intgrp_iconb" style="">
                              <div class="grve-image-icon">
                                <img decoding="async" width="76" height="76" src="https://ae.interactivegrp.com/wp-content/uploads/2020/08/enterprise.png" class="attachment-full size-full" alt="">
                              </div>
                              <div class="grve-box-content">
                                <div class="grve-box-title-wrapper">
                                  <h4 class="grve-box-title grve-h4">Large Enterprises</h4>
                                </div>
                              </div>
                            </div>
                            <p style="font-size: 17px;line-height: 20px;text-align: left" class="vc_custom_heading vc_do_custom_heading">Interactive Group has dedicated its resources in developing cutting edge solutions and digital transformation to large enterprises in all the market segments. We aspire to deliver innovative products and solutions and offer outstanding services with our technology offerings and infrastructure to these enterprises</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="grve-section grve-row-section grve-fullwidth-background grve-padding-top-1x grve-padding-bottom-3x grve-bg-none grve-custom-height grve-middle-content grve-show-custom-height" data-tablet-landscape-equal-columns="false" data-tablet-portrait-equal-columns="false" data-mobile-equal-columns="false">
                    <div class="grve-container">
                      <div class="grve-row grve-bookmark grve-columns-gap-45">
                        <div class="grve-column wpb_column grve-column-1-2 grve-middle">
                          <div class="grve-column-wrapper" style="height: 414px;">
                            ...
                            <div class="grve-element grve-box-icon grve-small grve-side-icon grve-align-left lh_52 intgrp_iconb" style="">
                              <div class="grve-image-icon">
                                <img decoding="async" width="77" height="77" src="https://ae.interactivegrp.com/wp-content/uploads/2020/02/002-government.svg" class="attachment-full size-full" alt="">
                              </div>
                              <div class="grve-box-content">
                                <div class="grve-box-title-wrapper">
                                  <h4 class="grve-box-title grve-h4">Government</h4>
                                </div>
                              </div>
                            </div>
                            <p style="font-size: 17px;line-height: 20px;text-align: left" class="vc_custom_heading vc_do_custom_heading">Technology can continue to transform the way government and public organizations operate. Interactive has both the technology, experience and expertise to help do just that while meeting, and exceeding our clients’ targets. Interactive’s portfolio of data, voice and managed services can help government organizations to ensure cost effective and secure high speed access to data and applications for their employees, stakeholders and the public they serve. You can count on our services with exceptionally high standards of reliability.</p>
                            <p style="font-size: 12px;line-height: 14px;text-align: left" class="vc_custom_heading vc_do_custom_heading">Our team of professionals will work with your team to assess optimal ways to cut costs, improve public confidence, and increase availability with reliable high speed access to mission critical data and applications.</p>
                          </div>
                        </div>
                        <div class="grve-column wpb_column grve-column-1-2 grve-middle">
                          <div class="grve-column-wrapper" style="height: 414px;">
                            <div class="grve-element grve-image grve-animated-item grve-duration-normal grve-fade-in-left bluebgbox_rb grve-align-center grve-animated" style="" data-delay="200">
                              <div class="grve-image-wrapper">
                                <img loading="lazy" decoding="async" width="722" height="532" src="https://ae.interactivegrp.com/wp-content/uploads/2020/02/Artboard-23-copy-2@2x-100.jpg" class="attachment-full size-full" alt="" srcset="https://ae.interactivegrp.com/wp-content/uploads/2020/02/Artboard-23-copy-2@2x-100.jpg 722w, https://ae.interactivegrp.com/wp-content/uploads/2020/02/Artboard-23-copy-2@2x-100-300x221.jpg 300w, https://ae.interactivegrp.com/wp-content/uploads/2020/02/Artboard-23-copy-2@2x-100-600x442.jpg 600w" sizes="auto, (max-width: 722px) 100vw, 722px" style="opacity: 1;">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="grve-row grve-bookmark grve-columns-gap-45 mobile_reverse">
                        <div class="grve-column wpb_column grve-column-1-2 grve-middle">
                          <div class="grve-column-wrapper" style="height: 414px;">
                            <div class="grve-element grve-image grve-animated-item grve-duration-normal grve-fade-in-right bluebgbox_lt grve-align-center grve-animated" style="" data-delay="200">
                              <div class="grve-image-wrapper">
                                <img loading="lazy" decoding="async" width="1124" height="828" src="https://ae.interactivegrp.com/wp-content/uploads/2020/08/Artboard-23@2x-100.jpg" class="attachment-full size-full" alt="" srcset="https://ae.interactivegrp.com/wp-content/uploads/2020/08/Artboard-23@2x-100.jpg 1124w, https://ae.interactivegrp.com/wp-content/uploads/2020/08/Artboard-23@2x-100-300x221.jpg 300w, https://ae.interactivegrp.com/wp-content/uploads/2020/08/Artboard-23@2x-100-1024x754.jpg 1024w, https://ae.interactivegrp.com/wp-content/uploads/2020/08/Artboard-23@2x-100-768x566.jpg 768w, https://ae.interactivegrp.com/wp-content/uploads/2020/08/Artboard-23@2x-100-600x442.jpg 600w" sizes="auto, (max-width: 1124px) 100vw, 1124px" style="opacity: 1;">
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="grve-column wpb_column grve-column-1-2 grve-middle">
                          <div class="grve-column-wrapper" style="height: 414px;">
                            ...
                            <div class="grve-element grve-box-icon grve-small grve-side-icon grve-align-left lh_52 intgrp_iconb" style="">
                              <div class="grve-image-icon">
                                <img loading="lazy" decoding="async" width="76" height="76" src="https://ae.interactivegrp.com/wp-content/uploads/2020/08/energy.png" class="attachment-full size-full" alt="">
                              </div>
                              <div class="grve-box-content">
                                <div class="grve-box-title-wrapper">
                                  <h4 class="grve-box-title grve-h4">Energy</h4>
                                </div>
                              </div>
                            </div>
                            <p style="font-size: 17px;line-height: 20px;text-align: left" class="vc_custom_heading vc_do_custom_heading">Innovations in technology are redefining the energy sector like no other industry. More than ever before, companies are being asked to invest in innovative, sustainable concepts. <br> Interactive U.A.E has helped energy companies in various environments such as Within these various areas such as <br> simulation and scenario planning features, parametric estimation for reliable forecasting, deliverables management and work package delegation <br> consolidation capabilities. </p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div id="nav_menu-2" class="grve-widget widget widget_nav_menu">
                        ...
                        <div class="menu-solution-and-services-container">
                          <ul id="menu-solution-and-services" class="menu">
                            ...
                            <li id="menu-item-863" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-295 current_page_item menu-item-863">
                ...
                <div class="grve-login-modal">
                  ...
                  <div class="grve-login-form grve-login-form-item grve-align-center" style="">
                    ...
                    <form id="grve_login_form" action="https://ae.interactivegrp.com/" method="post">
                      ...
                      <input type="hidden" name="_wp_http_referer" value="/industries/">
                    </form>
