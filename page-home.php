...
<html class="js cssanimations js_active  vc_desktop  vc_transform  vc_transform " lang="en-US">
  ...
  <head>
    <meta charset="UTF-8">
    <title>Interactive UAE – Fulfilling Hope</title>
    ...
    <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="https://ae.interactivegrp.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fae.interactivegrp.com%2F">
    <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="https://ae.interactivegrp.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fae.interactivegrp.com%2F&amp;format=xml">
    ...
    <link rel="alternate" title="JSON" type="application/json" href="https://ae.interactivegrp.com/wp-json/wp/v2/pages/9">
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://ae.interactivegrp.com/xmlrpc.php?rsd">
    <meta name="generator" content="WordPress 7.0">
    <link rel="canonical" href="https://ae.interactivegrp.com/">
    <link rel="shortlink" href="https://ae.interactivegrp.com/">
    ...
    <link rel="stylesheet" id="vc_typicons-css" href="https://ae.interactivegrp.com/wp-content/plugins/js_composer/assets/css/lib/typicons/typicons.min.css?ver=7.9" media="all">
    ...
    <style id="rs-plugin-settings-inline-css">
      #rev_slider_3_1_wrapper .hesperiden .tp-thumb {
        opacity: 1;
        -webkit-perspective: 600px;
        perspective: 600px
      }

      #rev_slider_3_1_wrapper .hesperiden .tp-thumb .tp-thumb-title {
        font-size: 12px;
        position: absolute;
        margin-top: -10px;
        color: #ffffff;
      ...
      #rev_slider_3_1_wrapper .hesperiden .tp-thumb.rs-touchhover .tp-thumb-title {
  ...
  <body id="grve-body" class="home wp-singular page-template-default page page-id-9 wp-theme-movedo wp-child-theme-movedo-child grve-vce-ver-3.2.2 grve-body grve-stretched wpb-js-composer js-comp-ver-7.9 vc_responsive rs-safari" cz-shortcut-listen="true">
    <!-- Theme Wrapper -->
    <div id="grve-theme-wrapper" class="" data-mask-layer="2" style="height: auto;">
      <div id="grve-theme-content">
        ...
        <header id="grve-header" class="grve-fullwidth" data-sticky="none" data-sticky-height="60" data-devices-sticky="no" data-devices-sticky-height="60">
          ...
          <span class="cursor">
            <span class="cursor-move-inner" style="transform: translate3d(709.248px, 535.742px, 0px);">
              <span class="cursor-inner"></span>
            </span>
            <span class="cursor-move-outer" style="transform: translate3d(709.458px, 535.524px, 0px);">
            ...
            <div id="grve-main-content">
              <div class="grve-main-content-wrapper clearfix">
                ...
                <div id="page-9" class="post-9 page type-page status-publish hentry">
                  <div class="grve-section grve-row-section grve-fullwidth grve-padding-bottom-1x grve-bg-none">
                    <div class="grve-container">
                      <div class="grve-row grve-bookmark grve-columns-gap-30">
                        <div class="grve-column wpb_column grve-column-1-2">
                          <div class="grve-column-wrapper">
                              ...
                              <div class="grve-column-inner wpb_column grve-column-1">
                                <div class="grve-column-wrapper-inner">
                                  ...
                                  <div class="grve-element grve-text">
                                    <h1 class="banner-text">With insights and experiences of three decades,</h1>
                                    <h4 class="banner-sub-text">we envision the next five years.</h4>
                            ...
                            <div class="grve-row-inner grve-bookmark banner-left-bottom">
                              <div class="grve-column-inner wpb_column grve-column-1-4 mobile-hide">
                                <div class="grve-column-wrapper-inner">
                                  <div class="grve-element grve-align-center banner-more-btn">
                                    <a href="#2nd_section" class="grve-btn grve-btn-medium grve-square grve-bg-primary-1 grve-bg-hover-black">
                                      <span>
                                        <i class="typcn typcn-arrow-right-thick"></i>More </span>
                                    </a>
                                  </div>
                                </div>
                              </div>
                              <div class="grve-column-inner wpb_column grve-column-3-4 animated-text">
                                <div class="grve-column-wrapper-inner">
                                  <div class="wpb_raw_code wpb_raw_html wpb_content_element">
                                    <div class="wpb_wrapper">
                                      <div class="banner-animated-text">
                                        <p>Excellence in the field of <span class="typed-text">Data migration</span>
                        ...
                        <div class="grve-column wpb_column grve-column-1-2">
                          <div class="grve-column-wrapper">
                            <!-- START Slider 2 REVOLUTION SLIDER 6.7.18 -->
                            <img src="/wp-content/uploads/2026/07/home-banner-2.jpg" width="70%">
                            <!-- END REVOLUTION SLIDER -->
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="grve-background-wrapper" id="2nd_section"></div>
                  </div>
                  ...
                  <div class="grve-section grve-row-section grve-fullwidth-background grve-padding-top-1x grve-padding-bottom-1x grve-bg-none" id="godown">
                    <div class="grve-container">
                      <div class="grve-row grve-bookmark grve-columns-gap-30">
                        <div class="grve-column wpb_column grve-column-1">
                          <div class="grve-column-wrapper">
                            <div class="grve-empty-space grve-height-1x" style=""></div>
                            <div class="grve-element grve-text">
                              <h3 style="text-align: center;">Hindsight of industry and insight of next-generation technologies <br>
                                <strong>enables us with the foresight to build solutions</strong>
                              </h3>
                            </div>
                            <div class="grve-empty-space grve-height-1x" style=""></div>
                            <div class="grve-element grve-image company-infographic grve-align-center" style="">
                              <div class="grve-image-wrapper">
                                <img loading="lazy" decoding="async" width="1515" height="679" src="https://ae.interactivegrp.com/wp-content/uploads/2020/03/Group-523.svg" class="attachment-full size-full" alt="" style="opacity: 1;">
                              </div>
                            </div>
                      ...
                      <div class="grve-row grve-bookmark grve-columns-gap-30">
                        <div class="grve-column wpb_column grve-column-1-4">
                          <div class="grve-column-wrapper">
                            ...
                            <div class="grve-element grve-text">
                              <h3>Our Happy Clients &amp; Partners</h3>
                            </div>
                            <div class="grve-empty-space grve-height-1x" style=""></div>
                            <div class="grve-element grve-text">
                              <p>Over our long history of over 34 years, we’ve had the honor of working with some of the top companies in the world across a number of fields.</p>
                            </div>
                            <div class="grve-empty-space grve-height-1x" style=""></div>
                          </div>
                        </div>
                            ...
                            <div class="grve-row-inner grve-bookmark">
                              <div class="grve-column-inner wpb_column grve-column-1-4">
                                <div class="grve-column-wrapper-inner">
                                  <div class="wpb_raw_code wpb_raw_html wpb_content_element">
                                    <div class="wpb_wrapper">
                                      <div class="logo-flip1">
                                        <div class="card1 card-top">
                                          <div class="flip-container1">
                                            <div class="flipper">
                                              <div class="front1">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/Adnoc.jpg" alt="">
                                              </div>
                                              <div class="back1">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/Etisalat.jpg" alt="">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="card">
                                          <div class="flip-container">
                                            <div class="flipper">
                                              <div class="front">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/LouvreAbuDhabi.jpg" alt="">
                                              </div>
                                              <div class="back">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/Gasco.jpg" alt="">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                              ...
                              <div class="grve-column-inner wpb_column grve-column-1-4">
                                <div class="grve-column-wrapper-inner">
                                  <div class="wpb_raw_code wpb_raw_html wpb_content_element">
                                    <div class="wpb_wrapper">
                                      <div class="logo-flip0">
                                        <div class="card card-top">
                                          <div class="flip-container">
                                            <div class="flipper">
                                              <div class="front">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/DubaiPolice.jpg" alt="">
                                              </div>
                                              <div class="back">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/RTA.jpg" alt="">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="card1 ">
                                          <div class="flip-container1">
                                            <div class="flipper">
                                              <div class="front1">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/DWC.jpg" alt="">
                                              </div>
                                              <div class="back1">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/Plainsware.jpg" alt="">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="logo-flip1">
                                        <div class="card1 card-top">
                                          <div class="flip-container1">
                                            <div class="flipper">
                                              <div class="front1">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/PlainswareOrchestra.jpg" alt="">
                                              </div>
                                              <div class="back1">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/Cleopatra.jpg" alt="">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="card">
                                          <div class="flip-container">
                                            <div class="flipper">
                                              <div class="front">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/Epam.jpg" alt="">
                                              </div>
                                              <div class="back">
                                                <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/Enstoa.jpg" alt="">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    <div class="wpb_wrapper">
                                      <div class="card card-top">
                                        <div class="flip-container">
                                          <div class="flipper">
                                            <div class="front">
                                              <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/IntelliGroups.jpg" alt="">
                                            </div>
                                            <div class="back">
                                              <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2020/02/Group-238.png" alt="">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="card1 ">
                                        <div class="flip-container1">
                                          <div class="flipper">
                                            <div class="front1">
                                              <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/IBM.jpg" alt="">
                                            </div>
                                            <div class="back1">
                                              <img decoding="async" src="https://ae.interactivegrp.com/wp-content/uploads/2022/11/Microsoft.jpg" alt="">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                ...
                <div class="grve-section grve-row-section grve-fullwidth-background grve-padding-top-1x grve-padding-bottom-1x grve-bg-none grve-custom-height grve-middle-content grve-show-custom-height">
                  <div class="grve-container">
                    <div class="grve-row grve-bookmark grve-columns-gap-30">
                      <div class="grve-column wpb_column grve-column-1-2 grve-middle">
                        <div class="grve-column-wrapper" style="height: 561px;">
                          <div class="wpb_raw_code wpb_raw_html wpb_content_element">
                            <div class="wpb_wrapper">
                              <p class="fancy">
                                <span>CORE TEAM</span>
                              ...
                              <div class="tp-main">
                                <h3 class="tp-thumb-title">Usman Yousuf</h3>
                                <h4 class="tp-thumb-designation">CHIEF EXECUTIVE OFFICER UAE</h4>
                                <p class="tp-thumb-description">Mr. Usman Yousuf is Chief Executive Officer UAE at Interactive Group. His primary responsibilities include developing and implementing business strategy for the Middle East operation. Mr. Yousuf holds an MBA from London Business School and an undergraduate degree in Mass Communication from the American University of Sharjah. He is a certified Project Management Professional (PMP) and also has a The Open Group Architecture Framework 9 certification. An attendant of several professional workshops and training sessions, he is finely skilled in the fields of strategy, negotiation and time management. Fluent in 3 languages, he has worked with the United Nations Office for Project Services in his previous role in business development at a regional IT firm. In addition to his professional work, he dedicates time to various community building projects in Pakistan.</p>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="grve-column wpb_column grve-column-1-2 grve-middle">
                        <div class="grve-column-wrapper" style="height: 561px;">
                          <div class="grve-element grve-image grve-align-center" style="">
                            <div class="grve-image-wrapper">
                              <img loading="lazy" decoding="async" width="459" height="561" src="https://ae.interactivegrp.com/wp-content/uploads/2020/02/usman_potrait.png" class="attachment-full size-full" alt="" srcset="https://ae.interactivegrp.com/wp-content/uploads/2020/02/usman_potrait.png 459w, https://ae.interactivegrp.com/wp-content/uploads/2020/02/usman_potrait-245x300.png 245w" sizes="auto, (max-width: 459px) 100vw, 459px" style="opacity: 1;">
                            </div>
                          </div>
                        </div>
                      </div>
    ...
    <link href="//fonts.googleapis.com/css?family=Montserrat:700%2C400%2C300%7CRoboto:400%2C300&amp;display=swap" rel="stylesheet" property="stylesheet" media="all" type="text/css">
    <script>
